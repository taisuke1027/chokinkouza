...
const CONFIG = {
  ...
  DECAY: {
    ...
    CURVE: [
      ...
      { fromDay: 4, toDay: 7, dailyRate: 0.0006 },   // 4〜7日: 緩やかな減価
      { fromDay: 8, toDay: 14, dailyRate: 0.0015 },  // 8〜14日: 徐々に減価率上昇
      { fromDay: 15, toDay: 30, dailyRate: 0.0025 }, // 15〜30日: さらに上昇
      { fromDay: 31, toDay: Infinity, dailyRate: 0.0035 }, // 長期無活動
    ],
